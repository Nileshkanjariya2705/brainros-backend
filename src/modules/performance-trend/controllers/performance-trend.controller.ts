...
import {
  GetTrendsQueryDto,
  CompareMocksQueryDto,
} from '../dto/performance-trend.dto';
...
export class PerformanceTrendController {
   ...
   */
  @Get('trends')
  getMyTrends(@CurrentUser() user: any, @Query() query: GetTrendsQueryDto) {
   ...
   */
  @Get('compare')
  compareMocks(@CurrentUser() user: any, @Query() query: CompareMocksQueryDto) {
